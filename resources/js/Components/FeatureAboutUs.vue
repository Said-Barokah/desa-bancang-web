...
<section class="md:relative static about_us md:mt-3 mt-24  padding_top overflow-hidden">
        ...
        <div class="flex md:flex-row flex-col content-between items-center">
            <div class="md:w-3/6  w-4/6 py-40 pr-20 md:inline hidden">
                <div class="about_us_img">
                    ...
                    <img v-show='isHiddenMap' class="shadow-2xl" src="/images/aboutUs/image866.webp" alt="" data-pagespeed-url-hash="3259222683" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                </div>
            </div>
    ...
    <div class="md:inline hidden">
        <img class="absolute top-9 left-28 -z-10" src="/images/aboutUs/g20931.webp" alt="">
    </div>
</section>
</template>
