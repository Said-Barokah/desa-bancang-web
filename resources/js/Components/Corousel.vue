...
<div id="default-carousel" class="relative" data-carousel="static">
    <div class="overflow-hidden relative h-screen rounded-lg xl:min-h-screen 2xl:min-h-screen">
        <div class="duration-700 ease-in-out absolute inset-0 transition-all transform translate-x-0 z-20 md:bg-cover bg-no-repeat bg-center" style="background-image: url('/images/corousel/slide-bg-1.webp')" data-carousel-item="">
